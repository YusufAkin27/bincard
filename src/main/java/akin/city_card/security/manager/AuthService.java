...
public interface AuthService {
    ...
    TokenResponseDTO driverLogin(HttpServletRequest request, QRLoginRequestDTO loginRequestDTO) throws DriverNotFoundException, IncorrectPasswordException, AccountFrozenException, PhoneNotVerifiedException, UnrecognizedDeviceException;
}
